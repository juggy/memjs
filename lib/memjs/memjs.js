...
Client.prototype.set = function(key, value, callback, options) {
  options = options || {};
  var extras = Buffer.concat([new Buffer('00000000', 'hex'), makeExpiration(options.expires || this.options.expires)]);
